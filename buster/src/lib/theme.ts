...
export const LIGHT_THEME: ThemePalette = {
  ...
  searchHighlight: "rgba(223, 142, 29, 0.2)",
  currentLine:     "rgba(172, 176, 190, 0.25)",
  ...
  syntax: {
    ...
    comment: "#636678",
    constant: "#a64200",
    "constant.builtin": "#a64200",
    constructor: "#1450c0",
    embedded: "#4c4f69",
    function: "#1450c0",
    "function.builtin": "#a64200",
    "function.macro": "#6e2dc0",
    keyword: "#6e2dc0",
    module: "#8a6200",
    number: "#a64200",
    operator: "#0e6269",
    property: "#1450c0",
    punctuation: "#5c5f77",
    "punctuation.bracket": "#5c5f77",
    "punctuation.delimiter": "#5c5f77",
    "punctuation.special": "#a04590",
    string: "#2a7d1a",
    "string.escape": "#a04590",
    "string.special": "#a04590",
    tag: "#6e2dc0",
    type: "#8a6200",
    "type.builtin": "#8a6200",
    variable: "#4c4f69",
    "variable.builtin": "#d20f39",
    "variable.parameter": "#b8303d",
  },
